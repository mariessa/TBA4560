...
Simple Object Access Protocol (SOAP) is a protocol that defines how XML and HTTP are used to get access to objects, services and serves, thus aiding in interoperability. SOAP may serve as a standard for all systems, because it is platform independent \cite{Sipes2004}.

a way applications can use XML to exchange structured and typed information \cite{Louridas2006}.
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|l|l|}
		...
		Technique / Service      & \begin{tabular}[c]{@{}l@{}}Platform \\ independent?\end{tabular} &  &  &  \\ \hline
		NGIS-API                 & -                     &  &  &  \\ \hline
		Geosynchronisation       & -                     &  &  &  \\ \hline
		Editing API (Cadastre)   & Yes                   &  &  &  \\ \hline
